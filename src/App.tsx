        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={
              ...
              <Route path="cpq/nova-cotacao" element={<div className="p-8">Nova Cotação - Em desenvolvimento</div>} />
              <Route path="cpq/historico" element={<div className="p-8">Histórico - Em desenvolvimento</div>} />
